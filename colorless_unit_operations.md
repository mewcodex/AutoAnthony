...
| 流星锤 `Bolas` | 0/-/Attack/SingleEnemy/Rare | ⟦T:D¦SingleEnemyOnly¦true¦None¦-1¦造成3点伤害。¦Deal 3 damage.⟧；⟦CL:AtNextTurnStart¦ConditionalTrigger¦false¦None¦-1¦在你的下个回合开始时。¦At the start of your next turn.⟧；⟦CL:ReturnThisToHand¦Independent¦false¦ThisCard¦1¦将此牌返回手牌。¦Return this card to your Hand.⟧ |  | Bolas |
...
| 黑暗镣铐 `DarkShackles` | 0/-/Skill/SingleEnemy/Uncommon | ⟦CL:TargetLoseStrengthThisTurn¦SingleEnemyOnly¦true¦None¦-1¦使该敌人在本回合失去9点力量。¦Enemy loses 9 Strength this turn.⟧ | Exhaust | Dark Shackles |
...
| 均衡 `Equilibrium` | 2/-/Skill/Other/Uncommon | ⟦N:B¦NonTargeted¦false¦None¦-1¦获得13点格挡。¦Gain 13 Block.⟧；⟦CL:RetainHandThisTurn¦NonTargeted¦false¦None¦-1¦在本回合保留你的手牌。¦Retain your Hand this turn.⟧ | Retain | Equilibrium |
...
| 花样百出 `JackOfAllTrades` | 0/-/Skill/Other/Uncommon | ⟦CL:AddRandomColorlessToHand¦NonTargeted¦false¦None¦-1¦将1张随机无色牌加入手牌。¦Add 1 random Colorless card into your Hand.⟧ | Exhaust | Jack of All Trades |
...
| 准备时间 `PrepTime` | 1/-/Power/Other/Uncommon | ⟦A:turnStart¦AbilityTrigger¦false¦None¦-1¦在你的回合开始时。¦At the start of your turn.⟧；⟦CL:GainVigor¦NonTargeted¦false¦None¦0¦获得3点活力。¦Gain 3 Vigor.⟧ |  | Prep Time |
...
| 箭雨 `Salvo` | 1/-/Attack/SingleEnemy/Uncommon | ⟦T:D¦SingleEnemyOnly¦true¦None¦-1¦造成12点伤害。¦Deal 12 damage.⟧；⟦CL:RetainHandThisTurn¦NonTargeted¦false¦None¦-1¦在本回合保留你的手牌。¦Retain your Hand this turn.⟧ | Retain | Salvo |
...
| 震荡波 `Shockwave` | 2/-/Skill/Other/Uncommon | ⟦CL:ApplyWeakAll¦NonTargeted¦false¦None¦-1¦给予所有敌人3层虚弱。¦Apply 3 Weak to ALL enemies.⟧；⟦CL:ApplyVulnerableAll¦NonTargeted¦false¦None¦-1¦给予所有敌人3层易伤。¦Apply 3 Vulnerable to ALL enemies.⟧ | Exhaust | Shockwave |
