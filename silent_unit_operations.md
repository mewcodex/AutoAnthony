...
| 夜魇 `Nightmare` | 3/-/Skill/Other/Rare | ⟦I:CopySelectedCardNextTurn¦Independent¦false¦None¦-1¦选择一张手牌。在下个回合，将该牌的3张复制品加入手牌。¦Choose a card in your hand. Next turn, add 3 copies of that card to your hand.⟧ | Exhaust |  |
...
| 精密瞄准 `Pinpoint` | 3/-/Attack/SingleEnemy/Uncommon | ⟦T:D¦SingleEnemyOnly¦false¦None¦-1¦造成15点伤害。¦Deal 15 damage.⟧；⟦C:whileInCombatSkillCostReduction¦ConditionalTrigger¦false¦None¦-1¦本回合每打出过一张技能牌，该牌的耗能减少1。¦That card costs 1 less for each Skill played this turn.⟧ |  |  |
